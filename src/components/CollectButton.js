  ...
  return (
    ...
    >
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <rect x="2" y="10" width="16" height="8" rx="1.2" stroke="white" strokeWidth="1.5"/>
            <path fillRule="evenodd" clipRule="evenodd" d="M4.79961 4.4502C3.72265 4.4502 2.84961 5.32324 2.84961 6.4002V10.052C2.96034 10.0183 3.07786 10.0002 3.19961 10.0002H4.34961V6.4002C4.34961 6.15167 4.55108 5.9502 4.79961 5.9502H15.1996C15.4481 5.9502 15.6496 6.15167 15.6496 6.4002V10.0002H16.7996C16.9214 10.0002 17.0389 10.0183 17.1496 10.052V6.4002C17.1496 5.32324 16.2766 4.4502 15.1996 4.4502H4.79961Z" fill="white"/>
        </svg>
